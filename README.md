...
```yaml
name: Khushal
role: B.Tech Student | ML Enthusiast
location: India 🇮🇳
Building new fun stuff for this world
currently_learning: Machine Learning & Deep Learning
fun_fact: I believe code can change the world, one commit at a time!
```
...
<p>
  ...
  <img src="https://img.shields.io/badge/Deep%20Learning-0071C5?style=for-the-badge&logo=pytorch&logoColor=white" />
